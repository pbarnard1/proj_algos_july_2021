...
- Solo project presentations will during at the *office hour* time of **4 PM** on **Tuesday, July 20** - so that's an hour earlier from when lecture starts!
- Make sure you have your groups formed if you haven't already!  Group project proposals are due **Wednesday, July 21**!
...
Other commands you might find handy (with references):
